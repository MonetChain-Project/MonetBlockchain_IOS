...
- (void)peripheralManager:(CBPeripheralManager *)peripheral didAddService:(CBService *)service error:(NSError *)error{
    if (error == nil) {
        //服务添加完成后发送广播 advertisementData 涉及重连
...
- (void)startService
{
     ...
     */
    CBMutableCharacteristic *readwriteCharacteristic = [[CBMutableCharacteristic alloc]initWithType:[CBUUID UUIDWithString:kBluetoottReadwriteCharacteristicUUID] properties:CBCharacteristicPropertyWrite|CBCharacteristicPropertyRead value:nil permissions:CBAttributePermissionsWriteable];
    //设置description
...
- (BOOL)writeData:(NSData *)subData{
    NSLog(@"000001010101010:\n%@\n%lu",subData,(unsigned long)[subData length]);
